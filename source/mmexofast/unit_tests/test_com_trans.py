...
class TestCOMass2COMag(unittest.TestCase):
    ...
    def do_wide_test(self, alpha):
        ...
        numpy.testing.assert_allclose(
            ...
            planet.get_magnification(params["t_0"]),
            rtol=0.01,
        )

    def test_wide_case_1(self):
        self.do_wide_test(0.0)

    def test_wide_case_2(self):
        self.do_wide_test(90.0)

    def test_wide_case_3(self):
        self.do_wide_test(180.0)

    def test_wide_case_4(self):
        self.do_wide_test(270.0)
...
class TestCOMag2COMass(unittest.TestCase):
    ...
    def do_wide_test(self, alpha):
        ...
        pspl = MulensModel.Model(
            {
                "t_0": co_magnif_params["t_0"],
                "u_0": co_magnif_params["u_0"],
                "t_E": co_magnif_params["t_E"],
            }
        )
        ...
        numpy.testing.assert_allclose(
            ...
            planet.get_magnification(co_magnif_params["t_0"]),
            rtol=0.01,
        )
...
class TestPrimary2COMass(unittest.TestCase):
    ...
    def test_close_case(self):
        self.skipTest(
            "test_close_case not implemented, probably has some weird offset due to mmv2 --> v3"
        )
