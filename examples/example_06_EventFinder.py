...
from data_for_test_examples import data_w149, datasets

import mmexofast as mmexo

# Do the EF search
ef = mmexo.gridsearches.EventFinderGridSearch(
    datasets=datasets, t_0_min=2459980.0, t_0_max=2460060.0
)
ef.run(verbose=True)
...
best_model = mmexo.gridsearches.EFSFitFunction(datasets, ef.best)
...
plt.plot(
    best_model.data[
        best_model.data_indices[0] : best_model.data_indices[1], 0
    ],
