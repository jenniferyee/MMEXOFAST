...
def plot_event(binary_params, title=None):
    ...
    event.plot(t_range=[2458350.0, 2458354.0], trajectory=False, title=title)
    plt.xlim(8350, 8354.0)


lc_num = 107
anomaly_params = {
    "t_0": 2458345.037965581,
    "t_E": 5.877334611399052,
    "u_0": 1.4810921099077317,
    "dmag": -0.11758628263201487,
    "dt": 0.06315800035372376,
    "t_pl": 2458352.3170020003,
}

data = TestDataSet(lc_num)
datasets = [
    mm.MulensData(file_name=f, phot_fmt="flux")
