...
solutions = exozippy.estimate_params.get_possible_bump_anomaly_solutions(
    anomaly_lc_params
)
print(solutions)
...
t_range = [
    anomaly_lc_params["t_pl"] - 10.0 * anomaly_lc_params["dt"],
    anomaly_lc_params["t_pl"] + 10.0 * anomaly_lc_params["dt"],
]
for key, solution in solutions.items():
    ...
    new_model.plot_lc(
        t_range=t_range,
        phot_fmt="mag",
        source_flux=ref_fluxes[0],
        blend_flux=ref_fluxes[1],
        label=key,
    )
