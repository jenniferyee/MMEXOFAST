...
results_3 = exozippy.mmexofast.fit(
    files=[files], fit_type="binary lens", assumption=None, print_results=True
)

# Find the best binary source model.
results_bs = exozippy.mmexofast.fit(
    files=[files], fit_type="binary source", print_results=True
)
